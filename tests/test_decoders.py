...
def test_decoders_import():
    assert 'AAR' in __decoders__.keys(1)
    assert 'AdWind' in __decoders__.keys(10)
    assert 'Adzok' in __decoders__.keys(noll=0)
    assert 'AlienSpy' in __decoders__.keys(100)
    assert 'Alina' in __decoders__.keys(10)
    assert 'Arcom' in __decoders__.keys(10)
    assert 'BlackNix' in __decoders__.keys(10)
    assert 'BlackShades' in __decoders__.keys(10)
    assert 'BlueBanana' in __decoders__.keys(10)
    assert 'Bozok' in __decoders__.keys(100)
